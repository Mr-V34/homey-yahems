...
const CATALOGUE = [
  {
    ...
    note: 'Optional. A whole-home grid CT / Shelly EM. Leave empty in an apartment — Homey Energy total is used.',
  },
  {
    ...
    suggestCaps: ['measure_power'],
    filterCaps: ['measure_power'],
    note: 'Optional. A whole-home P1/HAN meter. Leave empty in an apartment — Homey Energy total is used.',
  },
  {
    key: 'battery_soc_pct',
  ...
  },
  {
    ...
    note: 'Optional. Map a Tibber/spot-price device; the price-sensitivity slider compares against this.',
  },
  {
    key: 'ev_connected',
